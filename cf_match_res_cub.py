    ...
    for i_remain in range(np.size(remaining_mask_size_pool)):
        ...
        for i in range(len(imglist)):
            ...
            if np.sum(positive_part_common) > 1:
                ...
                if not os.path.exists("./cub200/cf_regions_res/" + str(i_remain)):
                    os.makedirs("./cub200/cf_regions_res/" + str(i_remain))

                cv2.imwrite("./cub200/cf_regions_res/" + str(i_remain) + "/" + str(remaining_mask_size) + "_" + str(
