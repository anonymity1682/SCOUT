...
parser.add_argument('--gpu', default='5,6,7,8', help='index of gpus to use')
...
parser.add_argument('--resume', default='checkpoint_pretrain_res34.pth.tar', type=str, metavar='PATH',
...
def main():
    ...
    # create model
    model_main = torch_models.resnet34(pretrained=True)
    ...
    model_ahp_trunk = torch_models.resnet34(pretrained=True)
    model_ahp_trunk.fc = nn.Linear(512 * 1, num_classes)
    ...
    model_ahp_hp = models.__dict__['ahp_net_hp_res50b']()
    ...
    }, filename='checkpoint_res34_hp.pth.tar')
