...
parser.add_argument('--resume', default='./ade/checkpoint_res34_hp.pth.tar', type=str, metavar='PATH',
...
def main():
    ...
    np.save('./ade/all_correct_res34_te.npy', all_correct_te)
    np.save('./ade/all_predicted_res34_te.npy', all_predicted_te)
    np.save('./ade/all_class_dis_res34_te.npy', all_class_dis_te)
    np.save('./ade/all_gt_target_res34_te.npy', all_gt_target_te)

    all_correct_teacher = np.load('./ade/all_correct_res34_te.npy')
    all_predicted_teacher = np.load('./ade/all_predicted_res34_te.npy')
    all_class_dis_teacher = np.load('./ade/all_class_dis_res34_te.npy')
    all_gt_target_teacher = np.load('./ade/all_gt_target_res34_te.npy')
